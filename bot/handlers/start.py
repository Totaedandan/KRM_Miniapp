...
WELCOME = (
    "\U0001f44b <b>Добро пожаловать в Turnitin Check</b>\n\n"
    "Услуги, цены, оплата, история и многое другое находятся внутри Mini App.\n\n"
    "Этот чат нужен только для двух действий:\n"
    "\U0001f4ce отправить документ после оплаты;\n"
    "\U0001f4c4 получить готовые PDF-отчёты.\n\n"
    "Откройте Turnitin Check ниже, чтобы начать.\n\n"
    "<blockquote>Открывая Mini App вы даете согласие на обработку личных "
    "данных(Политика конфиденциальности) и соглашаетесь с условиями "
    "пользования и возврата средств(Пользовательское соглашение, Политика "
    "оплат и возвратов) представленных ниже:\n\n"
    "Пользовательское соглашение: "
    "https://telegra.ph/Polzovatelskoe-soglashenie-08-12-56\n\n"
    "Политика конфиденциальности: "
    "https://telegra.ph/POLITIKA-KONFIDENCIALNOSTI-08-12-111\n\n"
    "Политика оплат и возвратов: "
    "https://telegra.ph/Politika-oplat-i-vozvratov-08-12</blockquote>"
)
